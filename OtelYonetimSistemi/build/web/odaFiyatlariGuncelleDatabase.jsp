<%-- 
    Document   : odaFiyatlariGuncelleDatabase
    Created on : 31.May.2022, 20:37:16
...
<html>
    ...
    <body>
        ...
        <%
            String oda = request.getParameter("oda");
            String yeniFiyat=request.getParameter("yeniFiyat");
            
            try {
                Connection con = ConnectionPro.getConnection();
                Statement st = con.createStatement();
                int i = st.executeUpdate("update odafiyat set fiyat='"+ yeniFiyat +"' where oda='"+oda+"'");
        %>
