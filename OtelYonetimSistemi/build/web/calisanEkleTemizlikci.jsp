<%-- 
    Document   : calisanEkleTemizlikci
    Created on : 31.May.2022, 14:39:55
    ...
    <section class="login">
        <div class="card z-depth-3">
            <div class="card-panel center grey accent-2">
                <span class="card-title">Temizlikçi Ekle</span>
            </div>
            <form class="form" action="calisanEkleDatabase.jsp" method="post"> 
                ...
                <input type="hidden" id="tip" name="tip" value="temizlikci">
                <div class="center">
