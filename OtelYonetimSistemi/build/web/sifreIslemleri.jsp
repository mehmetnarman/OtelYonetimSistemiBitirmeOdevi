<%-- 
    Document   : sifreIslemleri
    Created on : 31.May.2022, 19:40:53
...
<div class="genelAlan">
    ...
    <table class="tablo" border="1">
        ...
        %>
        <tr>
        <form action="sifreDegis.jsp">
            <td><%=rs.getString("name")%></td>
            <td><%=rs.getString("email")%></td>
            <td><%=rs.getString("tip")%></td>
            <td><%=rs.getString("password")%></td>
            <td><input type="input" name="yeniSifre" required></td>
                <input type="hidden" id="<%=rs.getString("idcalisan")%>" name="id" value="<%=rs.getString("idcalisan")%>">
